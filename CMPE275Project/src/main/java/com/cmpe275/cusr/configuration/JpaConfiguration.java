package com.cmpe275.cusr.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.cmpe275.cusr",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.cmpe275.cusr.model" });

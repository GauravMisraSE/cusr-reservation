	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row col-md-12" >
	                  ...
	                  <div class="row col-md-12">
						...
						<div class="col-md-2">
    							<input type="checkbox" ng-model= "chkExactTime" ng-true-value="'YES'" ng-false-value="'NO'">
		        ...
		        <table class="table table-hover">
		            ...
		            <tbody>
		             <tr ng-show="ctrl.returnSearch().length!=0" ng-repeat="u in ctrl.returnSearch()">
		                ...
		                <td><button type="button"  ng-click="ctrl.chkAvailable(u.name)" class="btn btn-success">Check Availability</button></td>
		               <!-- <td><button type="button" ng-click="ctrl.storeLocal(u.name)" class="btn btn-warning custom-width">Select</button></td>-->
		              <td> <input type="checkbox" ng-click="ctrl.storeLocal(u.name)" ng-model= "chkSelected" ng-true-value="'YES'" ng-false-value="'NO'">
		          ...
		          <tr>
		            <td>
  			  <button type="button" ng-click="ctrl.bookTkt()" class="btn btn-warning col-md-6">Book</button></td></tr>
  			<tr>
